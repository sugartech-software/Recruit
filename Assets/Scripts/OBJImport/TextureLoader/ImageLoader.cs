...
namespace Dummiesman
{
    public class ImageLoader
    {
        ...
        public static Texture2D LoadTexture(Stream textureStream, string ext)
        {
            TextureFormat textureFormat = TextureFormat.BMP;
            switch (ext)
            {
                case ".png":
                ...
                case ".jpg":
                case ".jpeg":
                    textureFormat = TextureFormat.JPG;
                    break;
                case ".dds":
                ...
                case ".tga":
                    ...
                    break;
                case ".bmp":
                    textureFormat = TextureFormat.BMP;
                    break;
                case ".crn":
                    textureFormat = TextureFormat.CRN;
                    break;
            }


            return LoadTexture(textureStream, textureFormat);
        }
